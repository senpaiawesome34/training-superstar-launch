      ...
      <section className="pt-32 pb-24 bg-gradient-dark">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-display font-bold mt-4 mb-6">
              Real People, <span className="text-gradient">Real Results</span>
            </h1>
            <p className="text-muted-foreground text-lg">
              Don't just take our word for it. Hear from everyday runners who
              transformed their fitness with TSA.
            </p>
          </div>
